...
export class ToDoListServiceProxy {
     ...
     * @return Success
     */
    deleteToDo(body: ToDoListDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/ToDoList/DeleteToDo";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    fetchAllToDos(userId: number | undefined): Observable<ToDoListDto[]> {
        let url_ = this.baseUrl + "/api/services/app/ToDoList/FetchAllToDos?";
        if (userId === null)
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchAllToDos(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchAllToDos(<any>response_);
                } catch (e) {
    ...
    protected processFetchAllToDos(response: HttpResponseBase): Observable<ToDoListDto[]> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    insertOrUpdate(body: ToDoListDto | undefined): Observable<ToDoListDto> {
        let url_ = this.baseUrl + "/api/services/app/ToDoList/InsertOrUpdate";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processInsertOrUpdate(response: HttpResponseBase): Observable<ToDoListDto> {
        const status = response.status;
        const responseBlob = 
            response instanceof HttpResponse ? response.body : 
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ToDoListDto implements IToDoListDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.completedOn = _data["completedOn"] ? moment(_data["completedOn"].toString()) : <any>undefined;
